...
def formatTable(result: list):
    ...
    #表格
    r += "<table class=\"dataframe\" border=\"0\"  style=\"word-break:break-all; color:white; position:absolute;top: 100px; margin-left:10%; margin-right:10%; \" >\r\n"
